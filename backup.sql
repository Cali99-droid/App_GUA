...
INSERT INTO `articulo_x_inventario` VALUES (1,1,1,'BUENO','Area de laboratorio de Ciencias'),(2,2,1,'BUENO','Area de laboratorio de Ciencias'),(3,3,1,'BUENO','Area de laboratorio de Ciencias'),(4,4,1,'BUENO','Area de laboratorio de Ciencias'),(5,1,2,'BUENO','Area de laboratorio de Ciencias'),(6,2,2,'BUENO','Area de laboratorio de Ciencias'),(7,3,2,'BUENO','Area de laboratorio de Ciencias'),(8,4,2,'BUENO','Area de laboratorio de Ciencias'),(9,5,2,'BUENO','Area de laboratorio de computacion'),(10,6,2,'BUENO','Area de laboratorio de computacion'),(11,7,2,'BUENO','Area de laboratorio de computacion'),(12,8,2,'BUENO','Area de laboratorio de computacion'),(13,1,3,'REGULAR','AREA DE MUSICA'),(14,2,3,'Regular','Area del limpieza'),(15,3,3,'Bueno','Area de laboratorio de computacion'),(16,4,3,'Bueno','Area de laboratorio de Ciencias'),(17,5,3,'Muy bueno','Area de laboratorio de computacion'),(18,6,3,'Regular','Area de Musica'),(19,7,3,'BUENO','AREA DE LABORATORIO DE CIENCIAS'),(20,8,3,'Bueno','Area de laboratorio de Ciencias'),(21,9,3,'INSERVIBLE','AREA DEL LIMPIEZA'),(22,1,4,'MALO','AREA DE MUSICA'),(23,2,4,'Regular','Area del limpieza'),(24,3,4,'Bueno','Area de laboratorio de computacion'),(25,4,4,'Bueno','Area de laboratorio de Ciencias'),(26,5,4,'Muy bueno','Area de laboratorio de computacion'),(27,6,4,'Regular','Area de Musica'),(28,7,4,'Bueno','Area de laboratorio de Ciencias'),(29,8,4,'Bueno','Area de laboratorio de Ciencias'),(30,9,4,'Regular','Area de Musica'),(31,10,4,'Regular','Area del limpieza'),(32,1,5,'REGULAR','AREA DE MUSICA'),(33,2,5,'Regular','Area del limpieza'),(34,3,5,'Bueno','Area de laboratorio de computacion'),(35,4,5,'Bueno','Area de laboratorio de Ciencias'),(36,1,8,'INSERVIBLE','AREA DEL LIMPIEZA'),(37,2,8,'Regular','Area del limpieza'),(38,3,8,'Bueno','Area de laboratorio de computacion'),(39,4,8,'Bueno','Area de laboratorio de Ciencias'),(40,1,9,'INSERVIBLE','AREA DE MUSICA'),(41,2,9,'REGULAR','AREA DE LABORATORIO DE CIENCIAS'),(42,3,9,'Bueno','Area de laboratorio de computacion'),(43,1,10,'MUY BUENO','AREA DE MUSICA'),(44,2,10,'REGULAR','AREA DE LABORATORIO DE COMPUTACION'),(45,3,10,'Bueno','Area de laboratorio de computacion'),(46,4,10,'Bueno','Area de laboratorio de Ciencias');
...
INSERT INTO `concepto` VALUES (1,'Certificado',10.00),(2,'FUT',5.00);
...
INSERT INTO `detalle` VALUES (1,2,1),(2,2,2),(3,3,2),(4,3,2),(5,4,2),(6,4,1),(7,5,1),(8,6,1),(9,6,2),(10,7,2),(11,8,1),(12,9,1),(13,9,2),(14,10,2),(15,11,1),(16,12,1),(17,13,2),(18,14,2),(19,14,2),(20,14,1),(21,15,1),(22,15,1),(23,16,1),(24,16,2),(25,17,2),(26,18,1),(27,19,1),(28,19,1),(29,20,1),(30,21,2),(31,22,2),(32,23,1),(33,23,2),(34,24,1),(35,24,2),(36,24,1),(37,24,2),(38,24,1),(39,25,1),(40,25,2),(41,25,1),(42,26,1),(43,26,1);
...
INSERT INTO `inventario` VALUES (1,'Inventario1','2020-03-01','2020-03-02','Se observaron dificultades en la identificacion de los materiales',1),(2,'Inventario2','2020-12-30','2020-12-31','todo en orden',1),(3,'NUEVO INVENTARIO - 2021','2021-09-11','2021-09-11','esta es una observacion',1),(4,'INVENTARIO II - 2021','2021-09-30','2021-09-30','esta es una observacion',1),(5,'PRUEBA 1 - 2021','2010-05-12','2010-05-12','prueba 1',1),(6,'PRUEBA 2 - 2021','2010-05-12','2010-05-12','rddgc',1),(7,'PRUEBA3 - 2021','2010-05-12','2010-05-12','',1),(8,'INVENTARIO DE PRUEBA 3 - 2021','2010-05-12','2010-05-12','todo en orden',1),(9,'EL INVENTARIO - 2021','2010-05-12','2010-05-12','',1),(10,'INVENTARIO PRUEBA 4 - 2021','2010-05-12','2010-05-12','adsfdgf',1);
...
INSERT INTO `usuario` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','admin',1),(2,'carlos','dc599a9972fde3045dab59dbd1ae170b','ADMIN',5),(3,'oscar','f156e7995d521f30e6c59a3d6c75e1e5','ADMINISTRADOR',20);
...
IF((SELECT COUNT(*) FROM PERSONA WHERE DNI = P_DNI) > 0) THEN
	...
	INSERT INTO COMPROBANTE VALUES (NULL, concat('GUA',lpad(COD,5,0)),(SELECT CURDATE()), P_MONTO, IDPER);
ELSE
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERT_DETALLE`(P_CONCEPTO VARCHAR(45))
BEGIN
DECLARE IDCON INT;
DECLARE IDCOMP INT;
SET IDCOMP = (SELECT MAX(idcomprobante) FROM COMPROBANTE);
SET IDCON = (SELECT IDCONCEPTO FROM CONCEPTO WHERE CONCEPTO = P_CONCEPTO);
INSERT INTO DETALLE(idcomprobantes, idconceptos) VALUES (IDCOMP, IDCON);
...
-- Dump completed on 2021-10-01  2:04:05
